...
export const permissions = shield(
  {
    Query: {
      ...
      globalCapabilitySettings: isAdmin,
    ...
    Mutation: {
      ...
      setGlobalCapability: isAdmin,
      setPartnerCapabilityOverride: isAdmin,
      setGlobalCapabilities: isAdmin,
      setNicheCapabilities: isAdmin,
      setPartnerCapabilities: isAdmin,
